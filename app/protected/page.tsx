...
import ClickableImage from "@/app/protected/clickable-image";
      ...
      <main key={page} className="mx-auto w-full max-w-6xl px-6 py-16 sm:py-20">
        <div className="flex items-center justify-end gap-4">
          <form action={signOut}>
            <button
              type="submit"
              className="rounded-full border border-black/15 px-4 py-2 text-sm transition-colors hover:border-black/35"
            >
              Sign out
            </button>
          </form>
        ...
        <div className="mx-auto mt-10 max-w-2xl text-center">
          <p className="text-xs uppercase tracking-[0.3em] text-black/45">Protected feed</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
            The Humor Project
          </h1>
          <p className="mt-4 text-sm text-black/60">Signed in as {user.email ?? "Unknown user"}</p>
        </div>
